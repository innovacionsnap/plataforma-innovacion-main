...
<link rel="stylesheet" href="vendor/chartjs-legend/css/demo.css">
<script src="vendor/chartjs-legend/src/legend.js"></script>
...
<div id="main_container">
	...
	<div class="row container_indicadores">
		<div class="col-sm-6 indicador_div_container">
			
			<div class="indicador_div">
				<span class="top_title_indicador_div">Titulo</span>
				<div class="indicador_div_grafica">
					<center>
						<canvas id="canvas"></canvas>
					</center>	
					<div id="barLegend"></div>
				</div>
				<div class="indicador_div_descripcion">
			...
			<div class="indicador_div">
				...
				<div class="indicador_div_descripcion">
					...
					<p>
						<button type="button" class="btn btn-primary btn-xs">Ver Descripción Completa</button>
					</p>
				</div>
			</div>
			...
			<div class="indicador_div">
				...
				<div class="indicador_div_grafica">
					<center>
						<div id="canvas5" style="width:100%; height:225px;"></div>
					</center>	
				</div>
				<div class="indicador_div_descripcion">
					<span class="indicador_div_descripcion_titulo">Descripción:</span>
		...
		<div class="col-sm-6 indicador_div_container">
			...
			<div class="indicador_div">
				...
				<div class="indicador_div_grafica">
					<center>
						<div id="canvas6" style="width:100%; height:225px;"></div>
					</center>	
				</div>
				<div class="indicador_div_descripcion">
					<span class="indicador_div_descripcion_titulo">Descripción:</span>
...
//Chart Library Class Object

var grafico_1 =  new data_graph();

//Read Package

grafico_1.api_data_server = 'http://data.upf.edu';
grafico_1.api_catalog_name = 'upf-en-xifres';

//Bar

data_labels = ["IMBABURA2","TUNGURAHUA2"];
data_content = [155,459];

grafico_1.get_bar_chart('Primer Dataset','canvas','barLegend',data_labels,data_content);

//Radar

label_titles = ["Primero Dataset", "Segundo Dataset"];
data_labels = ["Eating", "Drinking", "Sleeping", "Designing", "Coding", "Cycling", "Running"];
data_content = [[65,59,90,81,56,55,40],[28,48,40,19,96,27,100]];

grafico_1.get_radar_chart(label_titles, 'canvas2', 'radarLegend', data_labels, data_content);
...
$(function() {
	...
	$("#canvas6").prepend("Flot " + $.plot.version + " &ndash; ");
});

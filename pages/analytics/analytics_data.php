...
set_include_path('../../vendor/google-api-php-client-master/src');
...
//$toDate = date('Y-m-d');
//$toDate = '2014-06-25';
$fromDate = $_POST['fecha_inicio'];
$toDate = $_POST['fecha_fin'];
...
//array("Institucion"=>"Presidencia de la República del Ecuador", "Web"=>"www.presidencia.gob.ec" , "Profile_Id"=>"62828532"),
